...
# -*- coding: utf-8 -*-
#
# HoloPy documentation build configuration file, created by
# sphinx-quickstart on Wed Sep 21 14:21:20 2016.
#
...
sys.path.insert(0, os.path.abspath('../holopy'))
...
version = str(hp.__version_info__[0])+'.'+str(hp.__version_info__[1])
# The full version, including alpha/beta/rc tags.
release = hp.__version__
...
man_pages = [
    ('index', 'HoloPy', 'HoloPy Documentation',
     ['Manoharan Lab, Harvard University'], 1)
]
...
texinfo_documents = [
  ('index', 'HoloPy', 'HoloPy Documentation',
   'Manoharan Lab, Harvard University', 'HoloPy', 'One line description of project.',
   'Miscellaneous'),
]
